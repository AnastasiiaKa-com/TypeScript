...
function App() {
  return(
    ...
    <Routes>
       ...
       <Route path="/src/homeworks/homework05" element={<Homework05/>}/>
       <Route path="/src/homeworks/homework08" element={<Homework08/>}/>
       <Route path="/src/homeworks/homework10" element={<Homework10/>}/>
       <Route path="/src/homeworks/homework12" element={<Homework12/>}/>
